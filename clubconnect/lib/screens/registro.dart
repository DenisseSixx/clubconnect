                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Unete',
                              textAlign: TextAlign.center, style: TextStyle( fontFamily:'Outfit ', fontSize: 25, fontWeight: FontWeight.bold),
        ...
        child: Column(
          ...
          //  SizedBox(height: 32.0),
           ...
           // SizedBox(height: 10.0),
            ...
            child:ElevatedButton(onPressed: null, child: Text('Registrarse')) , ),)
            ,
